...
def streamlit_config():
    ...
    # page configuration    
    page_icon_url = 'https://github.com/Nandhagopal1319/Airbnb-Analysis/blob/main/airbnb_logo.png'
...
with st.sidebar:
    image_url = 'https://github.com/Nandhagopal1319/Airbnb-Analysis/blob/main/airbnb_banner.jpg'
